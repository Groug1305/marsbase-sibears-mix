...
def get_trades(coin1="btc", coin2="usd", limit=150, amount=0): # совершенные сделки
...
def main():
    # print(get_info()) # страшно, не включай
    # print(get_ticker())
     print(get_ticker(coin1="doge"))
    # print(get_depth())
     print(get_depth(coin1="doge"))
    # print(get_depth(coin1="doge", limit=2000))
     print(get_trades(coin1="doge", coin2="usd", limit=150, amount=1000))
